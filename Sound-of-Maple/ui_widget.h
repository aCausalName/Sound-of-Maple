...
""));
        ...
        widget_bottons->setGeometry(QRect(0, 440, 471, 51));
        ...
        widget_playProcess->setGeometry(QRect(30, 405, 701, 41));
...
"}"));
        ...
        label_nowPlay->setGeometry(QRect(100, 347, 360, 65));
        ...
        label_nowPlay2->setGeometry(QRect(12, 368, 80, 23));
...
"}"));
        ...
        tabWidget->setGeometry(QRect(20, 20, 411, 331));
...
"}"));
        ...
        songListWidget = new QListWidget(songList);
        songListWidget->setObjectName("songListWidget");
        songListWidget->setGeometry(QRect(0, 0, 408, 307));
        QFont font2;
        ...
        songListWidget->setStyleSheet(QString::fromUtf8(""));
        tabWidget->addTab(songList, QString());
        lyric = new QWidget();
        lyric->setObjectName("lyric");
        lyric->setStyleSheet(QString::fromUtf8("QTabWidget::pane\n"
"{\n"
"border-color: #FF0000;\n"
"}"));
        tabWidget->addTab(lyric, QString());
        comment = new QWidget();
        comment->setObjectName("comment");
        tabWidget->addTab(comment, QString());
    ...
    void retranslateUi(QWidget *Widget)
    {
        ...
        label_attention->setText(QCoreApplication::translate("Widget", "\346\234\254\347\250\213\345\272\217\344\273\205\346\224\257\346\214\201mp3\357\274\214wav, flac, m4a, mp4\347\232\204\346\222\255\346\224\276\357\274\201", nullptr));
        ...
        tabWidget->setTabText(tabWidget->indexOf(songList), QCoreApplication::translate("Widget", "\346\255\214\345\215\225", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(lyric), QCoreApplication::translate("Widget", "\346\255\214\350\257\215", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(comment), QCoreApplication::translate("Widget", "\350\257\204\350\256\272", nullptr));
    } // retranslateUi
