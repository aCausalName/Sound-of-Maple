...
void Widget::keyPressEvent(QKeyEvent* event)
{
    ...
    if ( event->modifiers() == Qt::ControlModifier )
    {
        switch ( event->key() )
        {
        case Qt::Key_Right : this->on_pushButton_next_clicked();  break;
        case Qt::Key_Left  : this->on_pushButton_last_clicked();  break;
        case Qt::Key_Up    : ui->soundSlider->setValue( ui->soundSlider->value() + 1 );break;
        case Qt::Key_Down  : ui->soundSlider->setValue( ui->soundSlider->value() - 1 );break;
        }
    }
    ...
    switch ( event->key() )
    {
    case Qt::Key_Space : this->on_pushButton_switch_clicked();break;
    }
}
